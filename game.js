...
var levels = {
  ...
  growing : {name : "Growing", level : 0, xp : 0, xpReq : 5, xpReqBase : 5, unlocked : false, xpSecCounter : 0, skillType : "constitutioning", type : "basic", color : "rgb(0,200,0)", parent : "levelsDiv", stars : 0, unlockText : "it seems there is more to this life than not dying", hint : "you are seriously impatient"},
  eating : {name : "Eating", level : 0, xp : 0, xpReq : 30, xpReqBase : 30, unlocked : false, xpSecCounter : 0, skillType : "constitutioning", type : "basic", color : "rgb(150,100,0)", parent : "levelsDiv", stars : 0, unlockText : "apparently eating is a good part of growing more", hint : "try clicking the only button on your screen apart from this one"},
  drinking : {name : "Drinking", level : 0, xp : 0, xpReq : 30, xpReqBase : 30, unlocked : false, xpSecCounter : 0, skillType : "constitutioning", type : "basic", color : "rgb(50,50,200)", parent : "levelsDiv", stars : 0, unlockText : "apparently drinking is also a part of growing more", hint : "you are terrible at games"},
  thinking : {name : "Thinking", level : 0, xp : 0, xpReq : 10, xpReqBase : 10, unlocked : false, xpSecCounter : 0, skillType : "intelligenceing", type : "basic", color : "rgb(200,200,0)", parent : "levelsDiv", stars : 0, unlockText : "i wonder what we can come up with if we just stop and think", hint : "you need to grow up before i overload your brain"},
  upgrading : {name : "Upgrading", level : 0, xp : 0, xpReq : 10, xpReqBase : 10, unlocked : false, xpSecCounter : 0, skillType : "intelligenceing", type : "basic", color : "rgb(100,100,200)", parent : "levelsDiv", stars : 0, unlockText : "i can totally make myself better using this", hint : "hold on, let me think if i should tell you.... nah"},
  sleeping : {name : "Sleeping", level : 0, xp : 0, xpReq : 30, xpReqBase : 30, unlocked : false, xpSecCounter : 0, skillType : "constitutioning", type : "basic", color : "rgb(100,100,120)", parent : "levelsDiv", stars : 0, unlockText : "oh, sleeping is great, and maybe something will happen if i just keep sleeping?", hint : "only some kind of an upgraded piece of slime can figure it out, so not you"},
  clicking : {name : "Clicking", level : 0, xp : 0, xpReq : 100, xpReqBase : 100, unlocked : false, xpSecCounter : 0, skillType : "dexteritying", type : "basic", color : "rgb(150,100,100)", parent : "levelsDiv", stars : 0, unlockText : "clicking is also great, i heard those that are good at it develop magic powers", hint : "this is just a reminder that you should stop looking at the source files"},
  evolving : {name : "Evolving", level : 0, xp : 0, xpReq : 10, xpReqBase : 10, unlocked : false, xpSecCounter : 0, skillType : "constitutioning", type : "basic", color : "rgb(100,150,100)", parent : "levelsDiv", stars : 0, unlockText : "this is another great way to make myself better!", hint : "do you ever think before you act?"},
  killing : {name : "Killing", level : 0, xp : 0, xpReq : 50, xpReqBase : 50, unlocked : false, xpSecCounter : 0, skillType : "strengthing", type : "basic", color : "rgb(250,0,0)", parent : "levelsDiv", stars : 0, unlockText : "if i kill some of the creatures around, maybe i can do something?", hint : "you are too far below me in darwinian terms"},
  assimilating : {name : "Assimilating", level : 0, xp : 0, xpReq : 50, xpReqBase : 50, unlocked : false, xpSecCounter : 0, skillType : "constitutioning", type : "basic", color : "rgb(250,0,150)", parent : "levelsDiv", stars : 0, unlockText : "ah, i can consume those corpses to grow more...", hint : "just go postal, its perfectly legal around here"},
  automating : {name : "Automating", level : 0, xp : 0, xpReq : 10, xpReqBase : 10, unlocked : false, xpSecCounter : 0, skillType : "intelligenceing", type : "basic", color : "rgb(250,200,50)", parent : "levelsDiv", stars : 0, unlockText : "wow, so many options, i wonder what this one does?", hint : "this one is hard... try thinking about it"},
  accelerating : {name : "Accelerating", level : 0, xp : 0, xpReq : 100, xpReqBase : 100, unlocked : false, xpSecCounter : 0, skillType : "dexteritying", type : "basic", color : "rgb(250,200,200)", parent : "levelsDiv", stars : 0, unlockText : "the more i accelerate, the faster i go", hint : "let machines do the work (i hope skynet happens)"},
  learning : {name : "Learning", level : 0, xp : 0, xpReq : 50, xpReqBase : 50, unlocked : false, xpSecCounter : 0, skillType : "wisdoming", type : "basic", color : "rgb(0,150,250)", parent : "levelsDiv", stars : 0, unlockText : "if i learn a little bit, maybe i can think while doing other stuff?", hint : "lets just say you need to get on my alpha predator level"},
  levelUping : {name : "Level Uping", level : 0, xp : 0, xpReq : 10, xpReqBase : 10, unlocked : false, xpSecCounter : 0, skillType : "charismaing", type : "basic", color : "rgb(150,150,150)", parent : "levelsDiv", stars : 0, unlockText : "leveling up just leads to more leveling up!", hint : "you require additional level ups"},
  idling : {name : "Idling", level : 0, xp : 0, xpReq : 50, xpReqBase : 50, unlocked : false, xpSecCounter : 0, skillType : "wisdoming", type : "basic", color : "rgb(100,100,150)", parent : "levelsDiv", stars : 0, unlockText : "ive slept enough, now just being around causes things to happen for some reason?", hint : "go to sleep, preferably forever"},
  randomNumberGenerating : {name : "RNG'ing", level : 0, xp : 0, xpReq : 30, xpReqBase : 30, unlocked : false, xpSecCounter : 0, skillType : "intelligenceing", type : "basic", color : "rgb(250,250,250)", parent : "levelsDiv", stars : 0, unlockText : "ah, random numbers, i heard the higher they are, the better it is.", hint : "stop touching the damn buttons"},
  gathering : {name : "Gathering", level : 0, xp : 0, xpReq : 400, xpReqBase : 400, unlocked : false, xpSecCounter : 0, skillType : "dexteritying", type : "basic", color : "rgb(100,80,20)", parent : "levelsDiv", stars : 0, unlockText : "if i gather some materials, i should be able to build something", hint : "something about life finding a way, leave your apedom behind"},
  building : {name : "Building", level : 0, xp : 0, xpReq : 1000, xpReqBase : 1000, unlocked : false, xpSecCounter : 0, skillType : "strengthing", type : "basic", color : "rgb(100,150,20)", parent : "levelsDiv", stars : 0, unlockText : "now i can build a home... for who?", hint : "go do the only job you are qualified to do... gathering in the fields"},
  efficiencyIncreasing : {name : "Efficiency Increasing", level : 0, xp : 0, xpReq : 200, xpReqBase : 200, unlocked : false, xpSecCounter : 0, skillType : "wisdoming", type : "basic", color : "rgb(250,100,100)", parent : "levelsDiv", stars : 0, unlockText : "if i increase my efficiency at doing things, that would probably help", hint : "fire your employes and hire robots"},
  mathematising : {name : "Mathematising", level : 0, xp : 0, xpReq : 500, xpReqBase : 500, unlocked : false, xpSecCounter : 0, skillType : "intelligenceing", type : "basic", color : "rgb(150,250,100)", parent : "levelsDiv", stars : 0, unlockText : "hm, math? why? i guess it might do something?", hint : "actually, just kill all the humans and bow down to your automatic-overlords"},
  saving : {name : "Saving", level : 0, xp : 0, xpReq : 200, xpReqBase : 200, unlocked : false, xpSecCounter : 0, skillType : "charismaing", type : "basic", color : "rgb(150,250,150)", parent : "levelsDiv", stars : 0, unlockText : "now i can save my progress! :D", hint : "are you sure this game auto saves? (you probably shouldnt refresh)"},
  ...
  familyAcquiring : {name : "Family Acquiring", level : 0, xp : 0, xpReq : 20, xpReqBase : 20, unlocked : false, xpSecCounter : 0, skillType : "charismaing", type : "advanced", color : "rgb(200,150,50)", parent : "levelsDiv", stars : 0, unlockText : "if i get a family, they can do stuff with me!", hint : "do what a real man should do, build a house"},
  understanding : {name : "Understanding", level : 0, xp : 0, xpReq : 100, xpReqBase : 100, unlocked : false, xpSecCounter : 0, skillType : "intelligenceing", type : "ultimate", color : "rgb(255,255,255)", parent : "levelsDiv2", stars : 0, unlockText : "i dont understand", hint : "just put 1 + 1 together"},
  collecting : {name : "Collecting", level : 0, xp : 0, xpReq : 10000, xpReqBase : 10000, unlocked : false, xpSecCounter : 0, skillType : "strengthing", type : "advanced", color : "rgb(200,0,100)", parent : "levelsDiv2", stars : 0, unlockText : "if i just collect all the knowledge im gaining... maybe i can do something with it", hint : "type 'upupdowndownleftrightleftrightba' and submit your answer"},
  absorbing : {name : "Absorbing", level : 0, xp : 0, xpReq : 1000, xpReqBase : 1000, unlocked : false, xpSecCounter : 0, skillType : "constitutioning", type : "advanced", color : "rgb(0,0,0)", parent : "levelsDiv2", stars : 0, unlockText : "now if i absorb everything ive collected....", hint : "i gave you a prestige mechanic for a reason, use it smart guy!"},
  training : {name : "Training", level : 0, xp : 0, xpReq : 1000, xpReqBase : 1000, unlocked : false, xpSecCounter : 0, skillType : "charismaing", type : "advanced", color : "rgb(200,50,50)", parent : "levelsDiv2", stars : 0, unlockText : "i can train my 'family' to do things! finally!", hint : "get a life, and a family"},
  displeasing : {name : "Displeasing", level : 0, xp : 0, xpReq : 60, xpReqBase : 60, unlocked : false, xpSecCounter : 0, skillType : "charismaing", type : "advanced", color : "rgb(250,100,50)", parent : "levelsDiv2", stars : 0, unlockText : "oh no, turns out nobody likes being trained", hint : "well, obviously, train your children to be slaves"},
  upsizing : {name : "Upsizing", level : 0, xp : 0, xpReq : 10, xpReqBase : 10, unlocked : false, xpSecCounter : 0, skillType : "strengthing", type : "advanced", color : "rgb(100,250,50)", parent : "levelsDiv2", stars : 0, unlockText : "the better i get at things, the bigger i become for some reason", hint : "one of the buttons is misspelled, click it"},
  selecting : {name : "Selecting", level : 0, xp : 0, xpReq : 150, xpReqBase : 150, unlocked : false, xpSecCounter : 0, skillType : "dexteritying", type : "advanced", color : "rgb(100,200,250)", parent : "levelsDiv2", stars : 0, unlockText : "i bet if i learn to select the good options, i might figure out some that im missing", hint : "enhance your gaming experience with this one simpe trick : git good"},
  reclaiming : {name : "Reclaiming", level : 0, xp : 0, xpReq : 100, xpReqBase : 100, unlocked : false, xpSecCounter : 0, skillType : "constitutioning", type : "advanced", color : "rgb(255,255,255)", parent : "levelsDiv2", stars : 0, unlockText : "ah, i can finally turn all that absorbed knowledge into something useful!", hint : "since you suck, try sucking everything inside you"},
  hovering : {name : "Hovering", level : 0, xp : 0, xpReq : 500, xpReqBase : 500, unlocked : false, xpSecCounter : 0, skillType : "dexteritying", type : "advanced", color : "rgb(160,160,255)", parent : "levelsDiv2", stars : 0, unlockText : "when i hover over hover, something happens?", hint : "beetween this game and death, what would you select?"},
  mining : {name : "Mining", level : 0, xp : 0, xpReq : 250, xpReqBase : 250, unlocked : false, xpSecCounter : 0, skillType : "strengthing", type : "advanced", color : "rgb(150,75,50)", parent : "levelsDiv2", stars : 0, unlockText : "hm, ive found a mine full of metals, maybe i should mine some?", hint : "its time to play minecraft, go collect some resources"},
  forging : {name : "Forging", level : 0, xp : 0, xpReq : 32, xpReqBase : 32, unlocked : false, xpSecCounter : 0, skillType : "strengthing", type : "advanced", color : "rgb(255,100,0)", parent : "levelsDiv2", stars : 0, unlockText : "now i can forge all that metal into ingots... what are they for?", hint : "i already told you, its time to play minecraft, do the thing thats the first part of the name"},
  crafting : {name : "Crafting", level : 0, xp : 0, xpReq : 10, xpReqBase : 10, unlocked : false, xpSecCounter : 0, skillType : "intelligenceing", type : "advanced", color : "rgb(150,200,50)", parent : "levelsDiv2", stars : 0, unlockText : "i can craft some items to make myself better!", hint : "now take all that iron ore you got after playing minecraft and make it into something useful"},
  equipping : {name : "Equipping", level : 0, xp : 0, xpReq : 300, xpReqBase : 300, unlocked : false, xpSecCounter : 0, skillType : "dexteritying", type : "advanced", color : "rgb(225,225,150)", parent : "levelsDiv2", stars : 0, unlockText : "if i equip enough items, maybe i can find the space for some more.", hint : "wait, you wanted to... equip your items? thats not how this game works, keep crafting slave"},
  rolling : {name : "Rolling", level : 0, xp : 0, xpReq : 10, xpReqBase : 10, unlocked : false, xpSecCounter : 0, skillType : "intelligenceing", type : "advanced", color : "rgb(125,100,255)", parent : "levelsDiv2", stars : 0, unlockText : "when i reroll the item affixes, i get the feeling there is more i can do", hint : "do what the karate kid did, put it on, take it off, drop it, pick it up, put it on the stand, take it off the stand, put it on, etc... yeah, i know im referencing the bad one"},
  itemUpgrading : {name : "Item upgrading", level : 0, xp : 0, xpReq : 20, xpReqBase : 20, unlocked : false, xpSecCounter : 0, skillType : "wisdoming", type : "advanced", color : "rgb(100,255,200)", parent : "levelsDiv2", stars : 0, unlockText : "i can finally upgrade! this should be useful.", hint : "if you still havent noticed, you generally just have to click the new buttons that appear on screen to unlock more buttons"},
  skilling : {name : "Skilling", level : 0, xp : 0, xpReq : 100, xpReqBase : 100, unlocked : false, xpSecCounter : 0, skillType : "charismaing", type : "advanced", color : "rgb(255,255,255)", parent : "levelsDiv2", stars : 0, unlockText : "now that im well equipped, i can get some skills that should help me, but i might need my training partners help with this", hint : "you need.... slightly better items before i let you continue, its to dangereous for a weak adventurer like you, you dont even have an arrow... anywhere in your body"},
  strengthing : {name : "Str-ing", level : 0, xp : 0, xpReq : 500, xpReqBase : 500, unlocked : false, xpSecCounter : 0, skillType : "strengthing", type : "advanced", color : "rgb(255,100,100)", parent : "skillingDiv", stars : 0, unlockText : "", hint : "you know there is no real goal to this game other than to get big numbers? therefore you can never win"},
  dexteritying : {name : "Dex-ing", level : 0, xp : 0, xpReq : 500, xpReqBase : 500, unlocked : false, xpSecCounter : 0, skillType : "dexteritying", type : "advanced", color : "rgb(100,255,100)", parent : "skillingDiv", stars : 0, unlockText : "", hint : "ok, i might as well explain some mechanics if you havent cheated and checked the js"},
  constitutioning : {name : "Con-ing", level : 0, xp : 0, xpReq : 500, xpReqBase : 500, unlocked : false, xpSecCounter : 0, skillType : "constitutioning", type : "advanced", color : "rgb(255,255,100)", parent : "skillingDiv", stars : 0, unlockText : "", hint : "leveling up takes x2 as much xp every level up, but there are many ways to boost your xp"},
  intelligenceing : {name : "Int-ing", level : 0, xp : 0, xpReq : 500, xpReqBase : 500, unlocked : false, xpSecCounter : 0, skillType : "intelligenceing", type : "advanced", color : "rgb(100,100,255)", parent : "skillingDiv", stars : 0, unlockText : "", hint : "items are probably the most powerful way to progress, try getting a ring or an amulet, also level up your items"},
  wisdoming : {name : "Wis-ing", level : 0, xp : 0, xpReq : 500, xpReqBase : 500, unlocked : false, xpSecCounter : 0, skillType : "wisdoming", type : "advanced", color : "rgb(255,255,100)", parent : "skillingDiv", stars : 0, unlockText : "", hint : "each item type does a certain unique thing, there are also unique affixes you can only get by leveling up crafting"},
  charismaing : {name : "Cha-ing", level : 0, xp : 0, xpReq : 500, xpReqBase : 500, unlocked : false, xpSecCounter : 0, skillType : "charismaing", type : "advanced", color : "rgb(255,100,255)", parent : "skillingDiv", stars : 0, unlockText : "", hint : "if you figured out all the codes to unlock tooltips legit, you are incredible, thanks for not cheating"},
  exporting : {name : "Exporting", level : 0, xp : 0, xpReq : 200, xpReqBase : 200, unlocked : false, xpSecCounter : 0, skillType : "wisdoming", type : "advanced", color : "rgb(150,250,150)", parent : "levelsDiv2", stars : 0, unlockText : "i can export all my progress, i dont see any point in that", hint : "save me the trouble, just figure it out yourself"},
  importing : {name : "Importing", level : 0, xp : 0, xpReq : 50, xpReqBase : 50, unlocked : false, xpSecCounter : 0, skillType : "wisdoming", type : "advanced", color : "rgb(150,250,250)", parent : "levelsDiv2", stars : 0, unlockText : "ah, if only i could import my progress onto another computer", hint : "i honestly am really impressed if you got this message in the log, just go export a few times"},
  achieving : {name : "Achieving", level : 0, xp : 0, xpReq : 1, xpReqBase : 1, unlocked : false, xpSecCounter : 0, skillType : "charismaing", type : "ultimate", color : "rgb(255,255,255)", parent : "levelsDiv2", stars : 0, unlockText : "turns out there are things called achievements that i can get, but they are secret", hint : "clearly you need to enchance your deduction capabilities, because this is just sad"},
  ...
  achievingUnderstanding : {name : "Achieving Understanding", level : 0, xp : 0, xpReq : 1, xpReqBase : 1, unlocked : false, xpSecCounter : 0, skillType : "wisdoming", type : "achievement", color : "rgb(255,255,255)", parent : "achievementsDiv", stars : 0, unlockText : "i understand!", hint : "do you understand?"},
  absolutePerfecting : {name : "Absolute Perfecting", level : 0, xp : 0, xpReq : 1, xpReqBase : 1, unlocked : false, xpSecCounter : 0, skillType : "strengthing", type : "achievement", color : "rgb(255,255,255)", parent : "achievementsDiv", stars : 0, unlockText : "im pretty sure that means i beat the game (congratz, if you got this legit, you are incredible, thank you for playing)", hint : "i doubt if anyone will ever get this one legit, i know i havent, just make.... the perfect item"},
};
...
function unlock(level){
  ...
  if(!loading){
    ...
    addToLog(levels[level].unlockText);
  }
